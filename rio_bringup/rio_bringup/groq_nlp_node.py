...
class GroqNLPNode(Node):
    def __init__(self):
        ...
        if not groq_api_key:
            ...
            self.get_logger().info("Groq API key configured successfully")
        ...
        self.declare_parameter('model_name', 'deepseek-r1-distill-llama-70b')
    ...
    def _get_ai_response(self):
        """Get response from Groq with history context"""
        try:
